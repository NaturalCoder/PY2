...
def main():
    ...
    for chave in range(86000000, 90000000):
        if chave % 100000 == 0:
...
#     ''')  # NOVA ADIÇÃO: Consulta SQL para buscar o arquivo criptografado
...
# def main():
#     """
#     Função principal que realiza a extração do arquivo criptografado,
#     aplica força bruta para encontrar a chave correta e descriptografa o conteúdo.
#     """
#     print('Iniciando busca ao tesouro...')
    
#     # Extrair o arquivo criptografado do banco de dados
#     db_to_file('arquivos.db', 'segredo.enc')
#     print('Arquivo segredo.enc extraído com sucesso.')  # NOVA ADIÇÃO: Extração do arquivo criptografado
    
#     # Ler o arquivo criptografado
#     with open('segredo.enc', 'rb') as f:
#         dados_cripto = f.read()
    
#     # Força bruta para encontrar a chave
#     print('Iniciando força bruta para encontrar a chave...')  # NOVA ADIÇÃO: Início da força bruta
#     for chave in range(100000000):  # De 00000000 a 99999999
#         texto = tentar_descriptografia(dados_cripto, chave)
#         if texto and "Parabéns" in texto:
#             print(f"Chave encontrada: {chave}")  # NOVA ADIÇÃO: Chave encontrada
#             print(f"Texto descriptografado: {texto}")  # NOVA ADIÇÃO: Texto descriptografado
#             break
#     else:
#         print("Nenhuma chave válida encontrada.")  # NOVA ADIÇÃO: Nenhuma chave válida encontrada
