    # Corrija o BUG que impede a exclusão de contatos
    # Diminua o tamanho do input telefone e coloque o e-mail na sua frente
    # Crie novo input "Observações" para os contatos,
    # Múltiplas linhas tamanho máximo 200 char
    # Faça o Pull Request com a entrega da atividade
...
class Contato(db.Model):
    ...
    observacoes = db.Column(db.String(200))  #NOVO CAMPO
...
def adicionar_contato():
    ...
    if request.method == 'POST':
        ...
        novo_contato = Contato(
            ...
            observacoes = request.form['observacoes']  #NOVO CAMPO
        )
