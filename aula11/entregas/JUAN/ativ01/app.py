...
class Contato(db.Model):
    ...
    observacao = db.Column(db.String(200))  # Limite de 200 caracteres
...
def adicionar_contato():
    ...
    if request.method == 'POST':
        ...
        if len(request.form['observacao']) > 200:
            return render_template('formulario.html', error="Observação deve ter no máximo 200 caracteres!")
...
def editar_contato(id):
    ...
    if request.method == 'POST':
        ...
        if len(request.form['observacao']) > 200:
            return render_template('formulario.html', contato=contato, error="Observação deve ter no máximo 200 caracteres!")
